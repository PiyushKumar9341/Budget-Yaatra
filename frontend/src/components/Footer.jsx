...
const MODAL_CONTENT = {
    privacy: {
        ...
        content: (
            <div className="space-y-4 text-white/80 font-editorial text-base leading-relaxed">
                ...
                <h4 className="font-display text-lg text-amber-500 mt-4">1. Information We Collect</h4>
                ...
                <h4 className="font-display text-lg text-amber-500 mt-4">2. Zero Commission & Zero Ads</h4>
                ...
                <h4 className="font-display text-lg text-amber-500 mt-4">3. Local Control</h4>
    ...
    terms: {
        ...
        content: (
            <div className="space-y-4 text-white/80 font-editorial text-base leading-relaxed">
                ...
                <h4 className="font-display text-lg text-amber-500 mt-4">1. Respect Local Communities</h4>
                ...
                <h4 className="font-display text-lg text-amber-500 mt-4">2. Honest Storytelling</h4>
                ...
                <h4 className="font-display text-lg text-amber-500 mt-4">3. Fair Use</h4>
    ...
    roots: {
        ...
        content: (
            <div className="space-y-4 text-white/80 font-editorial text-base leading-relaxed">
                ...
                <h4 className="font-display text-lg text-amber-500 mt-4">1. Never Commissioned</h4>
                ...
                <h4 className="font-display text-lg text-amber-500 mt-4">2. Empowering Local Bharat</h4>
                <p>We champion budget homestays, local dhabas, village artisans, and eco-conscious travelers who enrich local economies.</p>
                <h4 className="font-display text-lg text-amber-500 mt-4">3. Human First</h4>
        ...
        <footer className="mt-16 relative bg-black text-white pt-10 md:pt-14 pb-4 md:pb-6 px-6 md:px-12 flex flex-col justify-between overflow-hidden select-none" data-testid="site-footer">
            ...
            <div className="w-full flex-1 flex flex-col justify-center items-center relative z-10 mb-8 md:mb-12">
                ...
                >
                    ...
                    {/* Interactive Ultra Soft Warm Terracotta Lerp Spotlight Layer (Full Text Height Mask, Low Brightness) */}
                    <p
            ...
            {/* Overlaid Footer Content Grid at the Bottom — Pinned to Bottom Edge */}
                ...
                <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-10">
                    ...
                    <div className="md:col-span-5">
                        <Link to="/" className="inline-flex items-center gap-2.5 group text-white" data-testid="footer-logo">
                            <Mountain className="w-5 h-5 text-amber-600 transition-colors duration-300" />
                        ...
                        <form onSubmit={subscribe} className="mt-4 max-w-md" data-testid="newsletter-form">
                            ...
                            <div className="flex items-center gap-2 border-b border-white/30 pb-1">
                                ...
                                <button
                                    ...
                                    className="p-1.5 rounded-full bg-amber-600 text-white transition-all duration-300 hover:bg-amber-500 shadow-md"
                                    aria-label="Subscribe"
                                >
                                    <Send className="w-3.5 h-3.5" />
                                </button>
                            </div>
                            <p className="text-[11px] text-white/50 mt-1.5 font-editorial-italic">No spam. No sponsored posts. Ever.</p>
                        </form>
                    </div>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <ul className="space-y-2 font-editorial text-base text-white/85">
                            ...
                            <li>
                                <button onClick={() => setActiveModal("roots")} className="hover:text-amber-400 transition-colors text-white/80 outline-none text-left">
                                    Trust & Roots
                                </button>
                            </li>
                        </ul>
                    ...
                    <div className="md:col-span-3">
                        ...
                        <div className="flex flex-wrap gap-2.5">
                            {SOCIALS.map((s) => (
                                <a
                                    ...
                                    className="w-9 h-9 rounded-full border border-white/20 text-white flex items-center justify-center transition-colors duration-300 hover:bg-amber-600 hover:border-amber-600 shadow-sm"
                                >
                        ...
                        <a href="mailto:hello@budgetyaatra.in" className="font-editorial text-base text-white hover:text-amber-400 hover:italic transition-all inline-flex items-center gap-1">
                            hello@budgetyaatra.in <ArrowUpRight className="w-3.5 h-3.5" />
                        </a>
                    </div>
                </div>

                {/* Bottom bar — Right at the bottom edge */}
...
function FooterLink({ to, children }) {
    return (
        <Link to={to} className="group inline-flex items-center gap-1 transition-opacity duration-300 hover:text-amber-400 text-white/80">
...
function FooterExternal({ href, children }) {
    return (
        <a href={href} className="group inline-flex items-center gap-1 transition-opacity duration-300 hover:text-amber-400 text-white/80">
            <span className="group-hover:italic transition-all">{children}</span>
            <ArrowUpRight className="w-3 h-3 opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300" />
        </a>
    );
